...
class ChatListViewController: UIViewController {
    ...
    private func setupViews() {
        ...
        navigationController?.navigationBar.barTintColor = .rgb(red: 247, green: 252, blue: 254)
        navigationItem.title = "トーク"
        navigationController?.navigationBar.titleTextAttributes = [.foregroundColor: UIColor.gray]
        
        let rightBarButton = UIBarButtonItem(title: "ともだち追加", style: .plain, target: self, action: #selector(tappedNavRightBarButton))
